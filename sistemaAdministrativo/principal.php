<?php    
    ...
    if(!empty($_GET['Alteracao'])){
        ...
        $usuarios = mysqli_fetch_assoc($dados);         //Variável tem registros separados em colunas
        $destino = "./usuario/pull.php";
    }
?>
                    ...
                    <div class="col-md card">
                        ...
                        <table class="table" id="tabela">
                            ...
                            <tbody>
                                ...
                                <td> <a href="principal.php?Alteracao=<?=$coluna['id']?>"> <i class="fa-solid fa-pen-to-square" style="color:#0fa9eb";></i> </a></td>
                                <td> <a href="<?php echo "./usuario/delete.php?id=".$coluna['id']; ?>"> <i class="fa-solid fa-trash-can" style="color:#0fa9eb"></i> </a></td>
                                </tr>
                                <?php } ?>
                            </tbody>
